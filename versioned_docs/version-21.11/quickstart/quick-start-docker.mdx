...
:::note
 ...
 - You can also use [`rpk container`](/docs/21.11/deployment/guide-rpk-container) to run Redpanda in containers
...
- Get a multi-node cluster up and running using [`rpk container`](/docs/21.11/deployment/guide-rpk-container).
